...
from hal_impl.types import AnalogInputHandle, AnalogOutputHandle, AnalogTriggerHandle, CANHandle, CompressorHandle, ControlWord_ptr, CounterHandle, DigitalHandle, DigitalPWMHandle, EncoderHandle, GyroHandle, Handle, InterruptHandle, JoystickAxes_ptr, JoystickButtons_ptr, JoystickDescriptor_ptr, JoystickPOVs_ptr, MatchInfo_ptr, NotifierHandle, PDPHandle, PortHandle, RelayHandle, SolenoidHandle
from hal_impl.fndef import _RETFUNC, _THUNKFUNC
...
def _STATUSFUNC(name, restype, *params, out: Optional[Any] = ..., library=..., handle_missing: bool = ..., _inner_func=..., c_name: Optional[Any] = ..., errcheck: Optional[Any] = ...):
    ...
...
_report = _RETFUNC("report", C.c_int64, ("resource", C.c_int32), ("instanceNumber", C.c_int32), ("context", C.c_int32, 0), ("feature", C.c_char_p, None))
@hal_wrapper
...
initializeEncoder = _STATUSFUNC("initializeEncoder", EncoderHandle, ("digitalSourceHandleA", Handle), ("analogTriggerTypeA", C.c_int32), ("digitalSourceHandleB", Handle), ("analogTriggerTypeB", C.c_int32), ("reverseDirection", C.c_bool), ("encodingType", C.c_int32))
...
_transactionI2C = _THUNKFUNC("transactionI2C", C.c_int32, ("port", C.c_int32), ("deviceAddress", C.c_int32), ("dataToSend", C.POINTER(C.c_uint8)), ("sendSize", C.c_int32), ("dataReceived", C.POINTER(C.c_uint8)), ("receiveSize", C.c_int32))
@hal_wrapper
def transactionI2C(port, deviceAddress, dataToSend, receiveSize):
    ...

_writeI2C = _THUNKFUNC("writeI2C", C.c_int32, ("port", C.c_int32), ("deviceAddress", C.c_int32), ("dataToSend", C.POINTER(C.c_uint8)), ("sendSize", C.c_int32))
@hal_wrapper
def writeI2C(port, deviceAddress, dataToSend):
    ...

_readI2C = _THUNKFUNC("readI2C", C.c_int32, ("port", C.c_int32), ("deviceAddress", C.c_int32), ("buffer", C.POINTER(C.c_uint8)), ("count", C.c_int32))
@hal_wrapper
...
_transactionSPI = _THUNKFUNC("transactionSPI", C.c_int32, ("port", C.c_int32), ("dataToSend", C.POINTER(C.c_uint8)), ("dataReceived", C.POINTER(C.c_uint8)), ("size", C.c_int32))
@hal_wrapper
